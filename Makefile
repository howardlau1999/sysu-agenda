...
INCLUDE := -I./$(INC_DIR) -I$(ASIO_DIR) -I./gtest/include
TEST_LIBRARY := -L./gtest/lib -lgtest -lgtest_main
...
test: $(BUILD_DIR)/Date.o $(BUILD_DIR)/AgendaService.o $(BUILD_DIR)/AgendaUI.o $(BUILD_DIR)/User.o $(BUILD_DIR)/Meeting.o $(BUILD_DIR)/Storage.o
	@mkdir -p $(BIN_DIR)
